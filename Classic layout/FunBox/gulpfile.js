...
const watchFiles = () => {
  ...
  gulp.watch([config.watch.html], gulp.series(scssTask));
  gulp.watch([config.watch.html], gulp.series(jsTask));
  gulp.watch([config.watch.html], gulp.series(imgTask));
  gulp.watch([config.watch.html], gulp.series(fontsTask));
}
